        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <img src="{{url('public/assets')}}/img/pg3.png" alt="Images" width="20%">
              </td>
              <td class="product-name">
                <h2 class="h5 text-black">Static Bicycle</h2>
              </td>
              <td>RP.2.992.000</td>
              <td>
            ...
            <tr>
              <td class="product-thumbnail">
              <img src="{{url('public/assets')}}/img/pg5.png" alt="Images" width="20%">
              </td>
              <td class="product-name">
                <h2 class="h5 text-black">Lat pulldown machine</h2>
              </td>
              <td>RP.3.980.000</td>
              <td>
                <div class="input-group mb-3" style="max-width: 120px;">
     ...
     <div class="row">
      ...
      <select name="" class="form-control select2" id="kabupaten" onchange="gantiKabupaten(this.value)">
        ...
        <option value=""></option>
            ...
            <p><a href="checkout.html" class="btn btn-success py-2 px-4">Estimate</a></p>
          </form>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-7">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 text-right">
              <strong class="text-black">RP.6.872.000</strong>
            </div>
          </div>
          <div class="row mb-5">
            <div class="col-md-6">
